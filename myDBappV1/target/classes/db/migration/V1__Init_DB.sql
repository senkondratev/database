...
alter table if exists receipt drop constraint if exists FKjq3v0m6bmkmpe1rgieu3eut4u;
    ...
    create table bonus (bonus_id int4 generated by default as identity, bonus varchar(255), contract_id int4, primary key (bonus_id));
    create table building (building_id int4 generated by default as identity, level int4 not null, primary key (building_id));
    create table client (client_id int4 generated by default as identity, client_name varchar(255), client_surname varchar(255), first_appearance date, primary key (client_id));
    create table company (company_id int4 generated by default as identity, company_name varchar(255), primary key (company_id));
    create table contract (contract_id int4 generated by default as identity, company_id int4, primary key (contract_id));
    create table guest (guest_id int4 generated by default as identity, guest_review varchar(255), review_type boolean not null, client_id int4, company_id int4, reservation_id int4, room_id int4, primary key (guest_id));
    create table receipt (receipt_id int4 generated by default as identity, guest_id int4, service_id int4, primary key (receipt_id));
    create table reservation (reservation_id int4 generated by default as identity, end_date date, start_date date, building_id int4, primary key (reservation_id));
    create table room (room_id int4 generated by default as identity, is_empty boolean not null, room_capacity int4 not null, room_current_guest_count int4 not null, room_floor int4 not null, room_orders_count int4 not null, room_profit int4 not null, building_id int4, primary key (room_id));
    create table service (service_id int4 generated by default as identity, service_name varchar(255), service_price int4 not null, building_id int4, primary key (service_id));
