...
//данный запрос сейчас проверяет, спадет ли текущая бронь к указанному сроку, но не проверяет, попадает ли указанный срок в новую бронь.
// Добавить эту проверку на основе прошлых запросов не сложно, но нужно ли?